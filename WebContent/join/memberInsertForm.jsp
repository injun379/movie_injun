				...
				<div>
					...
					<div>
						...
						<div>
							...
							<br><br>
						    <div>
								<form name="memberInfo" action="/join/member_insert_pro.movie" method="post" onsubmit="return checkValue()">
										<table>
											...
											<tbody>
												<tr>
													...
													<td>
														...
														<button id="id_check" type="button" onclick="showPopup();">														
														<span>중복 확인</span>
														</button>
											...
											<tr>
												<th><label for="sel_gender">성별</label></th>
												<td>
									...
									<br> <button type="submit" id="sub_pro"><span>CGV 회원 가입</span></button>
								</form>	
							</div>
						</div>
